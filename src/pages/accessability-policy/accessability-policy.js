...
import './accessability-policy.scss';
    ...
    return (
        <div className="tab-pane fade show active static-page" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <div className="title-container">
                <h5 className="text-uppercase text-center">Accessability Policy</h5>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AccessabilityPolicy);
